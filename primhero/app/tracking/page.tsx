  ...
  return (
    <div className="overflow-x-hidden">
      <div className="bg-image2 h-screen w-full bg-cover bg-center text-center flex flex-col justify-center align-middle items-center gap-8">
        ...
        <article className="w-11/12 sm:w-1/3 md:w-1/2 lg:w-1/4    bg-white drop-shadow-3xl rounded-xl py-8 px-2 shadow-2xl flex justify-around items-center">
          ...
          <div className="flex border border-black/30 rounded-xl overflow-hidden h-12">
            ...
            />
            <button
              className="w-auto  m-auto cursor-pointer font-sans bg-secondary h-full pr-2 pl-2 -ml-4"
